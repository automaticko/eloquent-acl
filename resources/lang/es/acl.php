...
return [
    ...
    'import' => [
        ...
        'role'            => [
            'insert' => 'Se insertó el rol ":role_slug", con id ":role_id".',
            'update' => 'Se editó el rol ":role_slug", con id ":role_id".',
            'delete' => 'Se elimintó el rol ":role_slug" con id ":role_id".',
            'ignore' => 'Se ignoró el rol ":role_slug" con id ":role_id".',
        ],
        'permission'      => [
            'insert' => 'Se insertó el permiso ":permission_slug", con id ":permission_id".',
            'update' => 'Se editó el permiso ":permission_slug", con id ":permission_id".',
            'delete' => 'Se elimintó el permiso ":permission_slug" con id ":permission_id".',
            'ignore' => 'Se ignoró el permiso ":permission_slug" con id ":permission_id".',
        ],
        'permission_role' => [
            'insert' => 'Rol ":role_slug", se insertó el permiso ":permission_slug".',
            'delete' => 'Rol ":role_slug", se eliminó el permiso ":permission_slug".',
            'ignore' => 'Rol ":role_slug", se ignoró el permiso ":permission_slug".',
            'error'  => 'Error en permiso para el rol ":role_slug", el permiso ":permission_slug" no existe. Asegúrese de agregarlo a la configuración de acl en la sección de permisos.',
        ],
    ],
